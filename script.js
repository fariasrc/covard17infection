...
let coronaro = document.getElementById("coronaro");
...
function criarCobrinha(){
    ...
    for(i=0; i<snake.length;i++){
        ...
        context.drawImage(virus,snake[i].x,snake[i].y,imgbox,imgbox);
...
function desenharComida(){
    context.drawImage(coronaro,food.x,food.y,imgbox,imgbox);
    context.strokeStyle = "black";
